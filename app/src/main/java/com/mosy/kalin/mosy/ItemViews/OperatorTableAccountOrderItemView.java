...
public class OperatorTableAccountOrderItemView
    ...
    @ViewById(R.id.tableAccountMenuItem_tvName)
    TextView nameTextView;
    @ViewById(R.id.tableAccountMenuItem_tvStatus)
    TextView statusTextView;

    @ViewById(R.id.tableAccountMenuItem_llMarkDeliveredLoading)
    LinearLayout markDeliveredProgressLayout;
    @ViewById(R.id.tableAccountMenuItem_btnMarkDelivered)
    ...
    @Click(R.id.tableAccountMenuItem_btnMarkDelivered)
