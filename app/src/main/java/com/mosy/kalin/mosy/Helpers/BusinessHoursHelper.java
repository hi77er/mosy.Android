...
public class BusinessHoursHelper {
    ...
    public static WorkingStatus getWorkingStatus(VenueBusinessHours businessHours){
        ...
        if (day == Calendar.SUNDAY)
            return businessHours.IsSundayDayOff ? WorkingStatus.Closed : calculateStatus(businessHours.SundayFrom, businessHours.SundayTo);
        else if (day == Calendar.MONDAY)
            return businessHours.IsMondayDayOff ? WorkingStatus.Closed : calculateStatus(businessHours.MondayFrom, businessHours.MondayTo);
        else if (day == Calendar.TUESDAY)
            return businessHours.IsTuesdayDayOff ? WorkingStatus.Closed : calculateStatus(businessHours.TuesdayFrom, businessHours.TuesdayTo);
        else if (day == Calendar.WEDNESDAY)
            return businessHours.IsWednesdayDayOff ? WorkingStatus.Closed : calculateStatus(businessHours.WednesdayFrom, businessHours.WednesdayTo);
        else if (day == Calendar.THURSDAY)
            return businessHours.IsThursdayDayOff ? WorkingStatus.Closed : calculateStatus(businessHours.ThursdayFrom, businessHours.ThursdayTo);
        else if (day == Calendar.FRIDAY)
            return businessHours.IsFridayDayOff ? WorkingStatus.Closed : calculateStatus(businessHours.FridayFrom, businessHours.FridayTo);
        else if (day == Calendar.SATURDAY)
            return businessHours.IsSaturdayDayOff ? WorkingStatus.Closed : calculateStatus(businessHours.SaturdayFrom, businessHours.SaturdayTo);
        return WorkingStatus.Unknown;
    }

    private static WorkingStatus calculateStatus(Date from, Date to) {
