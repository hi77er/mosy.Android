...
public class ServiceEndpointFactory implements IServiceEndpointFactory {
    ...
    //private static final String devEndpoint = "http://10.0.2.2:/api/";
    private static final String devEndpoint = "http://mosyws/api/";
    private static final String tokenDevEndpoint = "http://mosyws/token";
    ...
    @Override
    public String getMosyWebAPITokenDevEndpoint() { return tokenDevEndpoint; }
